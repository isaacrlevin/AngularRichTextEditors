...
@Component({
  selector: 'app-angular-markdown',
  encapsulation: ViewEncapsulation.None,
  templateUrl: 'angular-markdown.component.html',
  styles: ['angular-markdown.component.css']
})
export class AngularMarkdownComponent implements OnInit {
